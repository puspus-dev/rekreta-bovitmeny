...
function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-100 to-teal-100 text-slate-900">
      <main className="max-w-6xl mx-auto px-6 py-12">
        <section className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-4">reKréta</h1>
          <p className="text-lg text-slate-700">
            Az e-Kréta, ahogy mindig is szeretted volna — színes, modern és élvezhető.
          </p>
        </section>
        ...
        <section className="mt-12">
          ...
          <p className="text-sm text-slate-700 mt-2">
            Képek feltöltése után ide kerülnek a képernyőképek, amelyek bemutatják a változásokat.
          </p>
        ...
        <section className="mt-12 mb-24 grid md:grid-cols-2 gap-8">
          <div className="bg-white rounded-2xl p-6 shadow-rk-md">
            ...
            <ol className="mt-3 text-sm text-slate-600 list-decimal list-inside space-y-2">
              ...
              <li>
                Kapcsold be a Fejlesztői módot, majd válaszd &quot;Betöltés kicsomagolt
                bővítményként&quot;.
              </li>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-rk-md">
            ...
            <ul className="mt-3 text-sm text-slate-600 space-y-2">
              <li>
                GitHub repo:{" "}
                <span className="font-mono text-xs">/rekreta-landing</span>
              </li>
      ...
      <footer className="bg-white/60 py-6 mt-12">
        <div className="max-w-6xl mx-auto px-6 text-center text-sm text-slate-700">
